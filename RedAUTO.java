...
@Autonomous (name = "CameraTestRedAUTO")
            ...
            switch (visionProcessor.getSelection()) {
                ...
                case LEFT:
                   ...
                   /* try {
                        ...
                        Bass_Pro_Shop.DriveSideways(.6, 1000, -1); //left
                        //Thread.sleep(500);
...
/*
                    try {
                        //put in movement code
                        Bass_Pro_Shop.DriveStraight(.5,1000,1); //forward
                    }
                    catch (InterruptedException e) {
                        throw new RuntimeException(e);
                    }*/
...
/*
                    try {
                        //put in movement code
                        Bass_Pro_Shop.DriveSideways(.6, 100, 1); //right
                    }
                    catch (InterruptedException e) {
                        throw new RuntimeException(e);
                    }*/
